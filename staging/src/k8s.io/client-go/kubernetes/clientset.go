...
type Interface interface {
	...
	ApiserverinternalV1alpha1() apiserverinternalv1alpha1.ApiserverinternalV1alpha1Interface
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	apiserverinternalV1alpha1    *apiserverinternalv1alpha1.ApiserverinternalV1alpha1Client
...
func (c *Clientset) ApiserverinternalV1alpha1() apiserverinternalv1alpha1.ApiserverinternalV1alpha1Interface {
	return c.apiserverinternalV1alpha1
}
...
func NewForConfig(c *rest.Config) (*Clientset, error) {
	...
	cs.apiserverinternalV1alpha1, err = apiserverinternalv1alpha1.NewForConfig(&configShallowCopy)
	if err != nil {
		return nil, err
	}
...
func NewForConfigOrDie(c *rest.Config) *Clientset {
	...
	cs.apiserverinternalV1alpha1 = apiserverinternalv1alpha1.NewForConfigOrDie(c)
...
func New(c rest.Interface) *Clientset {
	...
	cs.apiserverinternalV1alpha1 = apiserverinternalv1alpha1.New(c)
